...
# wp1: 2.5700, 0.53, 0.000, 0.000, 0.000, 0.96, -0.256
...
def get_waypoints():
    ...
    with open('/home/rick/catkin_ws/src/team_x_mapping/global-wp-2.txt', 'r') as f:
        lines = f.readlines()
        f.close()
    wp_num = len(lines)
...
def check_arrive(msg):
	...
	goal_reached = False
        if wp_idx >= wp_num:
            rospy.loginfo_throttle(1, "Tasks completed!.")
